# Generated by Django 3.0.6 on 2020-06-15 19:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('down_count', models.IntegerField(default=0, verbose_name='下载数量')),
            ],
        ),
        migrations.CreateModel(
            name='Blog',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('nid', models.AutoField(primary_key=True, serialize=False)),
                ('title', models.CharField(max_length=32, verbose_name='标题名称')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_comment', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='blog.Comment', verbose_name='父级评论')),
        ...
        migrations.AddField(
            model_name='userinfo',
            name='blog',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='blog.Blog', verbose_name='站点对象'),
        ),
        migrations.AddField(
            model_name='userinfo',
            name='groups',
